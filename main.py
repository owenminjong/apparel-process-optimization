        ...
        if os.path.exists('test_results/model_consistency_summary.json') and \
            ...
            try:
                ...
                consistency_results = {
                    ...
                    "model_mae_mean": model_consistency["mae_mean"],
                    "model_mae_std": model_consistency["mae_std"],
                    "model_mae_variability": model_consistency["mae_std"] / model_consistency["mae_mean"] * 100,
